...
const HEARING_SHEET_STEPS: HearingSheetStep[] = [
 ...
 { id: '勤務先情報', question: '勤務先情報（例：直属の上司など）', type: 'radio', options: ['部長', 'センター長', '課長', '係長', '主任', '店長', '支店長', 'マネージャー', 'リーダー', 'オーナー', 'その他'], required: false },
 ...
 // 5. ハラスメント・健康
 { id: 'ハラスメント有無', question: 'パワハラ・セクハラなどの問題はありますか？', type: 'radio', options: ['ある', 'ない'], required: true },
 { id: 'ハラスメント内容', question: 'ハラスメント問題がある場合、具体的な状況を教えてください', type: 'radio', options: ['パワハラ', 'セクハラ', 'マタハラ', 'モラハラ', 'いじめ', '暴言', '暴力', '長時間労働', 'その他'], required: false },
 { id: '健康上の問題有無', question: '健康上の問題はありますか？', type: 'radio', options: ['ある', 'ない'], required: true },
 { id: '健康上の問題の詳細', question: '健康上の問題がある場合、状況を教えてください', type: 'radio', options: ['うつ', '適応障害', '不眠症', '自律神経失調症', 'パニック障害', '身体疾患', 'メンタル不調', 'その他'], required: false },
