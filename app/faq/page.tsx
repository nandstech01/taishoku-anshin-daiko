...
export default function FAQ() {
    ...
    const faqs: FAQItem[] = [
        ...
        // 権利・保証
        {
            ...
            answer: "退職金や未払い残業代などの権利に関しては、提携している弁護士や労働組合をご紹介させていただきます。専門家のサポートを受けることで、適切な手続きを進めることができます。"
        },
        {
            category: "権利・保証",
            question: "失業保険はもらえますか？",
            answer: "はい、条件を満たせば受給可能です。失業保険の受給要件や手続き方法について、ハローワークに確認の上、必要な情報をご案内させていただきます。"
        },
        // プライバシー
        {
            category: "プライバシー",
