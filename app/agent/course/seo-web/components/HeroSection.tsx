    ...
    <section className="w-full relative text-white py-16 sm:py-24 px-4">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <h1 className="sm:hidden text-center">
          <span className="text-2xl font-bold block leading-tight">WEBサイトの</span>
          <span className="text-2xl font-bold block leading-tight">デジタル分析技術習得講座</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-8 mt-8 sm:mt-12 mb-6 sm:mb-8">
          <div className="flex items-center bg-black/30 p-3 sm:p-4 rounded-lg backdrop-blur-sm border border-white/20">
            <SiGoogleanalytics className="text-2xl sm:text-4xl mr-2 sm:mr-3" />
            <span className="text-sm sm:text-lg">Google Analytics</span>
          </div>
          <div className="flex items-center bg-black/30 p-3 sm:p-4 rounded-lg backdrop-blur-sm border border-white/20">
            <SiGooglesearchconsole className="text-2xl sm:text-4xl mr-2 sm:mr-3" />
            <span className="text-sm sm:text-lg">Search Console</span>
          </div>
          <div className="flex items-center bg-black/30 p-3 sm:p-4 rounded-lg backdrop-blur-sm border border-white/20">
            <FaSearch className="text-2xl sm:text-4xl mr-2 sm:mr-3" />
            <span className="text-sm sm:text-lg">SEO最適化</span>
          </div>
          <div className="flex items-center bg-black/30 p-3 sm:p-4 rounded-lg backdrop-blur-sm border border-white/20">
            <FaChartLine className="text-2xl sm:text-4xl mr-2 sm:mr-3" />
            <span className="text-sm sm:text-lg">データ分析</span>
          </div>
        </div>
        ...
        <div className="text-center mt-8 sm:mt-12">
          <a href="#details" className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 font-bold text-white overflow-hidden rounded-full border border-white/30 backdrop-blur-sm bg-white/10 hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl">
            ...
            <span className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-teal-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
          </a>
        </div>
      </div>
    </section>
