    ...
    try {
      ...
      if (h2Elements.length >= 2) {
        try {
          ...
          console.error('Error inserting comparison table before 2nd h2:', error);
        }
      }
      ...
      if (h2Elements.length >= 7) {
        try {
          ...
          console.error('Error inserting comparison table before 7th h2:', error);
        }
      } else {
    ...
    <div className="blog-content-processor">
      ...
      {isContentProcessed && adMarkers.map((marker, index) => {
        try {
          ...
          console.error(`Error rendering ad banner #${index}:`, error);
          return null;
        }
      })}
      ...
      {isContentProcessed && comparisonTableMarkers.length > 0 && comparisonTableMarkers.map((marker, index) => {
        try {
          ...
          console.error(`Error rendering comparison table #${index}:`, error);
          return null;
        }
      })}
    </div>
